...
/// </summary>
/// <remarks>
/// ash-drift.png tiles with no seam, so the layer drifts forever by moving the tiling origin.
/// Two of these at different speeds give the sky its parallax.
/// </remarks>
public class AshDriftSprite
{
    ...
    /// <summary>Creates an ash layer.</summary>
    ...
    /// <summary>Loads the ash texture.</summary>
    ...
    /// <summary>Drifts the layer, wrapping the offset so it never grows without bound.</summary>
    /// <param name="gameTime">The GameTime.</param>
    public void Update(GameTime gameTime)
    {
        _offset += _velocity * (float)gameTime.ElapsedGameTime.TotalSeconds;
        // %= keeps the offset inside the texture.
        _offset.X %= _texture.Width;
        _offset.Y %= _texture.Height;
    }

    /// <summary>Tiles the layer across the viewport.</summary>
